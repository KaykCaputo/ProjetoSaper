export function flip() {
	...
	var backDisplayStyle = window.getComputedStyle(backContent).getPropertyValue("display");
	...
	card.style.transform = card.style.transform === 'rotateY(360deg)' ? 'rotateY(0)' : 'rotateY(360deg)';
